...
require (
	...
	github.com/hugelgupf/p9 v0.3.1-0.20260209234446-ba5af0b37df0 // indirect
...
replace go.podman.io/podman/v6 => github.com/lstocchi/podman/v6 v6.0.0-20260529121339-be1756c425dd
